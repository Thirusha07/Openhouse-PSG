...
//                     <h3 className="text-white text-xl font-bold mb-2">{lab.labName}</h3>
//                     <p className="text-gray-300 text-sm">{lab.departmentName}</p>
//                   </div>
//                 </div>
//               </motion.div>
//             ))}
...
//           >
//             <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">About PSG College of Technology</h2>
//             <div className="max-w-4xl mx-auto">
//               <p className="text-xl text-gray-200 mb-8 leading-relaxed">
//                 Established in 1950, PSG College of Technology stands as a beacon of excellence in engineering education. 
//                 With over 75 years of academic distinction, we have consistently evolved to meet the changing demands of 
//                 technology and industry. Our commitment to innovation, research, and holistic development has made us 
...
//                   <p className="mt-4">
//                     <span className="font-semibold">Phone:</span> +91 422 257 2177
//                   </p>
//                   <p>
//                     <span className="font-semibold">Email:</span> info@psgtech.edu
//                   </p>
//                   <p>
//                     <span className="font-semibold">Website:</span> www.psgtech.edu
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//             exit={{ scale: 0.8, opacity: 0 }}
//             transition={{ duration: 0.3 }}
//             className="bg-gray-900 p-8 rounded-2xl shadow-2xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto"
//           >
//             <h2 className="text-3xl font-bold text-white mb-6 text-center">Request Visit</h2>
...
//                 value={bookingFormData.institute}
//                 onChange={handleInputChange}
...
//                 type="text"
//                 name="name"
//                 placeholder="Your Name (Teacher/Coordinator)"
...
//               <div>
//                 <label className="block text-white mb-2 font-semibold">Select a Visit Date</label>
//                 <select
//                   name="scheduleId"
//                   value={bookingFormData.scheduleId}
//                   onChange={handleDateChange}
...
//               <div>
//                 <label className="block text-white mb-2 font-semibold">Upload ID Proof Image (Max 2MB)</label>
//                 <input
//                   type="file"
//                   name="idProofImage"
//                   accept="image/*"
...
//                 {idProofPreview && (
//                   <div className="mt-4">
//                     <h4 className="text-white font-semibold mb-2">ID Proof Preview:</h4>
//                     <img
//                       src={idProofPreview}
